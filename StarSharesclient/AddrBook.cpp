...
IMPLEMENT_DYNAMIC(CAddrBook, CBaseDlg)

CAddrBook::CAddrBook(CWnd* pParent /*=NULL*/  , CString strTip /*=_T("")*/)
	: CBaseDlg(CAddrBook::IDD, pParent)
{
	m_strTip = strTip ;
	m_pBmp = NULL ;
...
BEGIN_MESSAGE_MAP(CAddrBook, CBaseDlg)
...
BOOL CAddrBook::OnInitDialog()
{
	...
	m_listCtrl.SetHeaderBKColor(87,101,112,0/*224,65,18,0*/); 
	...
	m_rBtnAdd.SetBitmaps( IDB_BITMAP_TC_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_TC_BUT2 , RGB(255, 255, 255) );
	...
	m_rBtnDelete.SetBitmaps( IDB_BITMAP_TC_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_TC_BUT2 , RGB(255, 255, 255) );
