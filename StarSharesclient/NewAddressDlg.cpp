...
IMPLEMENT_DYNAMIC(CNewAddressDlg, CBaseDlg)

CNewAddressDlg::CNewAddressDlg(CWnd* pParent /*=NULL*/)
    : CBaseDlg(CNewAddressDlg::IDD, pParent)
{
}
...
BEGIN_MESSAGE_MAP(CNewAddressDlg, CBaseDlg)
...
BOOL CNewAddressDlg::OnInitDialog()
{
	...
	m_rBtnNewAdd.SetBitmaps( IDB_BITMAP_TC_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_TC_BUT2 , RGB(255, 255, 255));
