...
BEGIN_MESSAGE_MAP(CMessageBoxEx, CBaseDlg)
...
//	m_strText.SetWindowText(m_Text);
	...
	m_quit.SetBitmaps( IDB_BITMAP_TC_CLOSE2 , RGB(0, 0, 0) , IDB_BITMAP_TC_CLOSE1 , RGB(0,0,0) );
	...
	*/
	...
	if ( (m_uType & MFB_OKCANCEL) == MFB_OKCANCEL ) {
		   m_OK.SetBitmaps( IDB_BITMAP_TC_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_TC_BUT2 , RGB(255, 255, 255) );
		   ...
		   m_OK.SizeToContent();
		   m_OK.MoveWindow(nLeftMargin, nDialogHight-nBtBottomMargin-23, 56, 23);
		   

		   m_cancel.SetBitmaps( IDB_BITMAP_TC_BUT1 , RGB(255, 255, 0) , IDB_BITMAP_TC_BUT2 , RGB(255, 255, 255) );
		   ...
		   //否按钮位置
		   m_cancel.MoveWindow(nLeftMargin + 66,nDialogHight-nBtBottomMargin-23, 56, 23);
	}
