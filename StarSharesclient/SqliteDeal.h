...
public:
	...
	//int			GetMyAssetList(const string &strCondition, map<string,uistruct::LISTMYASSET_t> *pListInfo);
	//int        GetMyAssetItem(const string &strCond, uistruct::LISTMYASSET_t *pMyAsset);
	
	int			GetAssetList(const string &strCondition, map<string,uistruct::LISTASSET_t> *pListInfo);
	int			GetAssetList(const string &strCondition, uistruct::ASSETLIST *pAssetList);
	int        GetAssetItem(const string &strCond, uistruct::LISTASSET_t *pAsset);

	int		   GetAssetParamList(const string &strCondition, uistruct::ASSETPARAMLIST *pAssetList);
	int        GetAssetParamItem(const string &strCond, uistruct::LISTASSETPARAM_t *pAsset);
};
